package com.zbie.materialsearchviewdemo.view;
...
import com.zbie.materialsearchviewdemo.adapter.SearchAdapter;
import com.zbie.materialsearchviewdemo.util.AnimationUtil;
 ...
 * 项目名           Practice03
 * 包名             com.zbie.materialsearchviewdemo.view
 * 创建时间         2017/05/10 20:05
 * 创建者           zbie
 * 邮箱             hyxt2011@163.com
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    public void showSuggestions() {
        int is = mSuggestionsListView.getVisibility();
        int count = mAdapter.getCount();
        boolean b = mAdapter != null && count > 0 && is == GONE;
        if (b) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        Log.d(TAG, "onSaveInstanceState: mSavedState.isSearchOpen = " + mSavedState.isSearchOpen);
        Log.d(TAG, "onSaveInstanceState: mSavedState.query = " + mSavedState.query);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (mSavedState.isSearchOpen) {
            Log.d(TAG, "onRestoreInstanceState: mSavedState.isSearchOpen = " + mSavedState.isSearchOpen);
            Log.d(TAG, "onRestoreInstanceState: mSavedState.query = " + mSavedState.query);
            showSearch(true);
            setQuery(mSavedState.query, true);
        }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return super.toString() + " === SavedState{" +
                    "query='" + query + '\'' +
