...
public class PagerSlidingTabStripExtends extends HorizontalScrollView {
    ...
    private int indicatorHeight = 11;
    ...
    public PagerSlidingTabStripExtends(Context context, AttributeSet attrs, int defStyle) {
        ...
        selectedTabTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, selectedTabTextColor, dm);
        /*--------------- add end -----------------*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float   triangleWidth = (float) (2 * indicatorHeight / Math.sqrt(3));
        //triangleWidth = 20;
